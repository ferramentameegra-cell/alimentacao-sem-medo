      ...
      <div className="relative z-10 min-h-screen py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-6xl font-extrabold mb-6 tracking-tight text-text-primary">
              Escolha seu Plano
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {/* PLANO 1 - Inteligente */}
            <div className={`bg-dark-secondary border-2 rounded-2xl p-10 transition-all duration-300 ${
              planoAtual === 1 
            ...
            >
              ...
              <ul className="space-y-4 mb-10">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-lg text-text-muted leading-relaxed line-through">
              ...
              {planoAtual === 1 ? (
                <button
                  ...
                  className="w-full py-5 px-6 bg-gradient-to-r from-neon-purple to-lilac hover:from-lilac hover:to-neon-purple text-white rounded-xl text-xl font-bold transition-all duration-300 shadow-neon-purple hover:shadow-large glow-purple"
                  style={{
            ...
            <div className={`bg-gradient-to-br from-dark-secondary to-dark-tertiary border-2 rounded-2xl p-10 relative transition-all duration-300 ${
              planoAtual === 2 
            ...
            >
              ...
              <button
                ...
                className="w-full py-5 px-6 bg-gradient-to-r from-neon-pink to-lilac hover:from-lilac hover:to-neon-pink text-white rounded-xl text-xl font-bold transition-all duration-300 shadow-neon-pink hover:shadow-large glow-pink disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
          ...
          <div className="text-center">
            <button
              onClick={() => router.push('/')}
              className="px-8 py-4 bg-dark-card border border-dark-border rounded-lg text-base font-semibold text-text-secondary hover:border-lilac/60 hover:text-lilac transition-all duration-300"
              style={{
